...
CREATE INDEX idx_meditation_versions_meditation_id ON meditation_versions(meditation_id);
CREATE INDEX idx_meditation_versions_is_live ON meditation_versions(is_live) WHERE is_live = true;
